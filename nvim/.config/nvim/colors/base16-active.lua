-- Tinty active scheme: Everforest Ink
-- Source: base16/everforest-ink.yaml
...
vim.g.colors_name = "base16-everforest-ink"
...
hi("FloatBorder", { fg = c.base0D, bg = none, bold = true })
...
hi("Directory", { fg = c.base0C, bold = true })
hi("EndOfBuffer", { fg = c.base00 })
hi("ErrorMsg", { fg = c.base08, bg = c.base00 })
hi("VertSplit", { fg = c.base03, bg = none })
hi("WinSeparator", { fg = c.base03, bg = none })
hi("Folded", { fg = c.base03, bg = c.base01 })
hi("FoldColumn", { fg = c.base03, bg = none })
hi("SignColumn", { fg = c.base03, bg = none })
hi("IncSearch", { fg = c.base01, bg = c.base09 })
hi("Substitute", { fg = c.base01, bg = c.base0A })
hi("LineNr", { fg = c.base03, bg = none })
hi("CursorLineNr", { fg = c.base0A, bg = none, bold = true })
...
hi("TelescopeNormal", { fg = c.base05, bg = none })
hi("TelescopeBorder", { fg = c.base0D, bg = none, bold = true })
hi("TelescopePromptNormal", { fg = c.base05, bg = none })
hi("TelescopePromptBorder", { fg = c.base0D, bg = none, bold = true })
hi("TelescopePromptTitle", { fg = c.base0D, bg = none, bold = true })
hi("TelescopePreviewTitle", { fg = c.base0B, bg = none, bold = true })
hi("TelescopeResultsTitle", { fg = c.base0A, bg = none, bold = true })
hi("TelescopeSelection", { fg = c.base0D, bg = none, bold = true })
...
hi("SnacksPicker", { fg = c.base05, bg = none })
hi("SnacksPickerBorder", { fg = c.base0D, bg = none, bold = true })
hi("SnacksPickerMatch", { fg = c.base0A, bold = true })
hi("SnacksPickerSelected", { fg = c.base0B, bg = none, bold = true })
...
hi("NormalSB", { fg = c.base05, bg = none })
hi("FoldColumnSB", { fg = c.base03, bg = none })
hi("SignColumnSB", { fg = c.base03, bg = none })
