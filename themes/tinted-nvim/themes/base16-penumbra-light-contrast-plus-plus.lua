-- Tinty active scheme: Penumbra Light Contrast Plus Plus
-- Source: base16/penumbra-light-contrast-plus-plus.yaml
...
vim.g.colors_name = "base16-penumbra-light-contrast-plus-plus"
