-- Tinty active scheme: Penumbra Dark Contrast Plus Plus
-- Source: base16/penumbra-dark-contrast-plus-plus.yaml
...
vim.g.colors_name = "base16-penumbra-dark-contrast-plus-plus"
